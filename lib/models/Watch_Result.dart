  ...
  DiscoverResponse.fromJson(dynamic json) {
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        results?.add(WatchesResults.fromJson(v));
      });
    }
...
class WatchesResults {
  ...
  WatchesResults.fromJson(dynamic json) {
    adult = json['adult'];
